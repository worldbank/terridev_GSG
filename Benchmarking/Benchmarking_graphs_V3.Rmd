...
integrated3<-mutate(integrated3, Efficiency_v0 = rowMeans(select(integrated3, c("agri_value_per", "agri_land_per", "gdp_ghg_per", "gov_effect_per", "cont_corr_per", "lpi_score_per", "sdg9_intuse_per", "water_efficiency_GDP_per", "Tenure.insecurity_per")), na.rm = TRUE))
} else {
  if (version == 1) {
    #V1 Resilience
...
#v8 Efficiency 
integrated3<-mutate(integrated3, Efficiency_v8 = rowMeans(select(integrated3, c("agri_value_per", "agri_land_per", "gdp_ghg_per", "gov_effect_per", "cont_corr_per", "gci_per",  "water_efficiency_GDP_per","rule_law_per" , "IT.CEL.SETS.P2_per", "IT.NET.USER.ZS_per","rapid_trans_per", "EG.EGY.PRIM.PP.KD_per", "reg_qua_per","patents_per","IS.SHP.GCNW.XQ_per","dai_per", 'SH.STA.MMRT_per')), na.rm = TRUE)) 
...
colnames(country_all)<-str_replace(colnames(country_all), "water_efficiency_GDP", "Water use efficiency (GDP/m3)")
...
country_all$region_red <- ifelse(country_all$region == "South Asia", "SAS",
                                ifelse(country_all$region ==  "Europe & Central Asia", 'ECA',
                                       ifelse(country_all$region ==  "Middle East & North Africa", 'MENA',
                                              ifelse(country_all$region ==  "Sub-Saharan Africa", 'SSF',
...
colnames(country_score)<-str_replace(colnames(country_score), "water_efficiency_GDP", "Water use efficiency (GDP/m3)")

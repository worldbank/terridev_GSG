...
# Load dataset from data generated in the previous section
  country_percent <- read.csv(file=paste0(dir_out, group,'/',"MENA_percentil_v",version,".csv"), header=TRUE, sep=",")
...
ggsave(com, file=paste0(dir_out, group,'/',"MENA_percentil_global_v",version,".pdf"), width=12, height=13)

...
# Set Directories
```{r}
dir_int<-"./Integrated data/v2/" #Folder with data generated in code Benchmarking_Data_V3
...
ggsave(graph2, file=paste0(dir_out, group,'/',"MENA_barplot_per_group_v",version,".pdf"), width=25, height=10)
...
ggsave(graph3, file=paste0(dir_out, group,'/',"MENA_barplot_per_region_v",version,".pdf"), width=25, height=10)
...
ggsave(graph4, file=paste0(dir_out, group,'/',"MENA_barplot_per_subregion_v",version,".pdf"), width=25, height=10)
...
write.csv(country_score, paste0(dir_out, group,'/',"MENA_score_graphs_v",version,".csv"), row.names = FALSE)
...
country_val<- read.csv(file=paste0(dir_out, group,'/',"MENA","_percentil_v",version,".csv"), header=TRUE, sep=",")%>%
  select(-percentil)
...
write.csv(income_info_country,paste0(dir_out, group,'/',"MENA_tables_data_v",version,".csv"), row.names = FALSE)
...
com <- ggplot(data3) +      
  ...
  geom_text(data=label_data3, aes(x=id, y=percentil+2, label= str_wrap(test, width = 23), hjust=label_data3$hjust), color="black", fontface="bold",alpha=1, size=perctext, angle= label_data3$angle, inherit.aes = FALSE ) +
...
ggsave(com, file=paste0(dir_out, group,'/',i,"_percentil_global_",".png"), width=11, height=11)
ggsave(com, file=paste0(dir_out, group,'/',i,"_percentil_global_",".pdf"), width=11, height=11)
...
label_data2$ind_value<-paste(as.numeric(label_data2$raw_value), "-", label_data2$indicator)
...
s <- ggplot(data2) +      
  ...
  geom_segment(data=grid_data2, aes(x = end, y = 20, xend = start, yend = 20), colour = "grey", alpha=1, size=0.3 , inherit.aes = FALSE ) +
    ...
    geom_label(x = 0, y = 0, label = i, hjust=0.5, fontface="bold", size=8) +
    annotate("text", x = rep(max(data2$id),5), y = c(20, 40, 60, 80, 100), label = c("20", "40", "60", "80", "100") , color="grey", size=3.5 , angle=0, fontface="bold", hjust=.5) +
  ...
  geom_text(data=label_data2, aes(x=id, y=tot-50, label= str_wrap(ind_value, width = 25), hjust=label_data2$hjust), color="black", fontface="bold",alpha=1, size=pillartext, angle= label_data2$angle, inherit.aes = FALSE ) 


ggsave(s, file=paste0(dir_out, group,'/',i,"_score_graph_sust_v",version,".png"), width=5.5, height=5.5)
ggsave(s, file=paste0(dir_out, group,'/',i,"_score_graph_sust_v",version,".pdf"), width=5.5, height=5.5)
...
ggsave(inc, file=paste0(dir_out, group,'/',i,"_score_graph_incl_v",version,".png"), width=5.5, height=5.5)
ggsave(inc, file=paste0(dir_out, group,'/',i,"_score_graph_incl_v",version,".pdf"), width=5.5, height=5.5)
...
ggsave(e, file=paste0(dir_out, group,'/',i,"_score_graph_eff_v",version,".png"), width=5.5, height=5.5)
ggsave(e, file=paste0(dir_out, group,'/',i,"_score_graph_eff_v",version,".pdf"), width=5.5, height=5.5)
...
ggsave(r, file=paste0(dir_out, group,'/',i,"_score_graph_res_v",version,".png"), width=5.5, height=5.5)
ggsave(r, file=paste0(dir_out, group,'/',i,"_score_graph_res_v",version,".pdf"), width=5.5, height=5.5)
...
country_all <- read.csv(paste0(dir_int,"World_SD_values_V5_index_2",version,".csv"))

...
#Set Directories
```{r}
dir_int<- "./Data/Benchmarking/SD_Profiles/Integrated data/"     #Folder with data generated in code Benchmarking_Data_V3
#dir_int<-"./My Files/Integrated data/"
...
#Function for PERCENTILE RANKING BAR GRAPH - Select regional_group in advance 
```{r}
for(i in country){

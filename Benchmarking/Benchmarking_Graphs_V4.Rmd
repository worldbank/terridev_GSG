...
#country=c("EGY")  #use one country for tests
...
country_percent<-country_percent%>% filter(indicator %nin%  c("*Security apparatus index", "Waste properly managed %", "Biodiversity & Habitat index", "Fisheries index", "*GHG intensity growth rate", "*CO2 emissions (mtr/ton pc)", "Water use efficiency (USD/m3)", "*Municipal soild waste (kg/pc/day)"))
...
country_score<-country_score%>% filter(indicator %nin%  c("*Security apparatus index", "Waste properly managed %", "Biodiversity & Habitat index", "Fisheries index", "*GHG intensity growth rate", "*CO2 emissions (mtr/ton pc)", "Water use efficiency (USD/m3)", "*Municipal soild waste (kg/pc/day)"))

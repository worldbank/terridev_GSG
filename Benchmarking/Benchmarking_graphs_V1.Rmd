...
##v0 
Refers to a set of indicators selected and vetted by the Chief Economist Office -Sustainable Development (work lead by Jason Daniel Russ). This version is updated with the criteria from November 30, 2020
##v1
...
group <- 'lics' ### HERE CHOOSE INCOME GROUP WE WANT TO COMPARE TO FROM ABOVE VARIABES ###

country="YEM"  #use one country for tests
...
colnames(country_all)<-str_replace(colnames(country_all), "ER.H2O.INTR.PC", "Renewal internal freshwater (m3 pc)")
...
sustainability<-c("Adjusted net savings %", "*PM2.5 mean annual exposure (\U00B5g/m3)", "Renewal energy consumption %", "Renewal internal freshwater (m3 pc)", "Water Quality SDG 6.3", "Wastewater treated %", "Waste properly managed %", "*Municipal soild waste (kg/pc/day)", "Biodiversity Habitat index", "Fisheries index", "GHG intensity growth rate", "*CO2 emissions (MT pc)", "*Forest loss %")
...
colnames(country_score)<-str_replace(colnames(country_score), "ER.H2O.INTR.PC", "Renewal internal freshwater (m3 pc)")
...
country_percent<-country_percent%>% filter(indicator %nin%  c("*Security apparatus index", "Waste properly managed %", "Biodiversity Habitat index", "Fisheries index", "GHG intensity growth rate", "*CO2 emissions (MT pc)", "Water use efficiency (USD/m3)", "*Municipal soild waste (kg/pc/day)"))
...
country_score<-country_score%>% filter(indicator %nin%  c("*Security apparatus index", "Waste properly managed %", "Biodiversity Habitat index", "Fisheries index", "GHG intensity growth rate", "*CO2 emissions (MT pc)", "Water use efficiency (USD/m3)", "*Municipal soild waste (kg/pc/day)"))
...
<!-- ```{r} -->
<!-- #Compare against countries with lager GDO per capita growth Vietnam, Peru, Indonesia -->
...
<!--   filter(str_detect(pilar, "v1"))%>% -->
<!--   mutate(pilar_name = str_replace(pilar, "_v0|_v1", "")) -->
<!-- country_comparators$pilar_name_f<- factor(country_comparators$pilar_name, levels= c("Resilience", "Inclusion", "Sustainability", "Efficiency")) -->
